...
/* ============================================================
   ...
   ============================================================ */
const NEWS = [
  { tag: "속보", color: "sky", emoji: "🛰️", domain: "finance.yahoo.com", img: "", title: "스페이스X, AI 코딩 도구 ‘커서’ 600억 달러에 인수", source: "Yahoo Finance 외", date: "2026.08",
    url: "https://finance.yahoo.com/technology/ai/articles/spacex-completes-record-60-billion-131311785.html",
    sum: "스페이스X가 바이브 코딩 대표 도구 ‘커서(Cursor)’를 만든 애니스피어를 약 600억 달러(80조 원대)에 인수 — 역대 최대 스타트업 인수 기록입니다.",
    why: "오늘 배우는 ‘AI로 코딩하기’가 지금 세계에서 가장 뜨거운 분야라는 증거." },
  { tag: "유머", color: "amber", emoji: "🪧", domain: "sfstandard.com", img: "", title: "‘최첨단 AI 챗봇’ 광고판, 알고 보니 사람 1명이 직접 답장", source: "SF Standard", date: "2026.08",
    url: "https://sfstandard.com/2026/08/04/sf-ai-hype-fake-chatbot-billboard/",
    sum: "샌프란시스코의 대형 광고판 속 챗봇 ‘ChatTJB’의 AI는 사실 ‘Average Individual(평범한 개인)’의 약자. 전직 구글러의 AI 과신 풍자 행위예술이었습니다.",
    why: "‘AI라면 무조건 믿는’ 세태에 대한 유쾌한 경고 — 검증하는 습관과 통합니다." },
...
const LIVEQ_BANK = [
  ...
  { cat: "smalltalk", q: "🪧 최신 유머! 지난달 샌프란시스코에 '최첨단 AI 챗봇 ChatTJB' 대형 광고판이 걸렸는데, 알고 보니 이 'AI'의 진짜 정체는?", o: ["진짜 초거대 인공지능", "평범한 사람(Average Individual) 1명이 직접 답장", "훈련된 앵무새", "1990년대식 자동응답기"], a: 1,
    explain: "AI가 'Average Individual(평범한 개인)'의 약자였다는 반전! 전직 구글러 터커 브라이언트가 6,000달러짜리 광고판으로 'AI라면 무조건 믿는 세태'를 풍자한 행위예술이었어요. 오늘 배우는 'AI의 답을 검증하기'와 딱 통하는 이야기죠 😄" },
  // ── 🤖 AI 상식 (오늘 배운 내용 복습 겸) ──
  ...
  // ── 📰 따끈따끈 최신 뉴스 (2026년 7~8월) ──
  { cat: "news", q: "📰 지난주(2026.8.14) 역대 최대 스타트업 인수 기록이 나왔어요! 스페이스X가 약 600억 달러(80조 원대)에 사들인 것은?", o: ["AI 코딩 도구 '커서(Cursor)'", "틱톡", "넷플릭스", "우주 호텔 체인"], a: 0,
    explain: "바이브 코딩의 대표 도구 '커서'가 우주 회사 품에 안겼습니다 🚀 오늘 우리가 배우는 'AI로 코딩하기'가 지금 세계에서 가장 뜨거운 분야라는 증거예요." },
  { cat: "news", q: "📰 구글이 지난주 '제미나이 3.7 플래시'를 공개했어요. 직전 모델(3.6 플래시)을 내놓은 지 얼마 만이었을까요?", o: ["3년 만에", "3개월 만에", "3주 만에", "3일 만에"], a: 2,
    explain: "겨우 3주! 새 AI 모델이 계절이 아니라 '주 단위'로 쏟아지는 시대예요. 그래서 특정 도구 암기보다 오늘 배우는 '원리 이해'가 오래갑니다." },
  { cat: "news", q: "📰 지난주 LG 구광모 회장과 엔비디아 젠슨 황 CEO가 만나 '피지컬 AI' 동맹을 맺었어요. 내년 1분기에 공개하겠다고 한 첫 결과물은?", o: ["AI 냉장고", "휴머노이드 로봇", "자율주행 트럭", "AI 에어컨"], a: 1,
    explain: "휴머노이드 로봇! AI가 화면 밖으로 나와 실제 세계에서 움직이고 판단하는 '피지컬 AI'가 다음 격전지인데, 한국 기업이 그 중심에 있어요 🇰🇷" },
];
